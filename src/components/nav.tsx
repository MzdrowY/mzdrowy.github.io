...
function GitHubIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" className="fill-zinc-400 transition-colors hover:fill-zinc-100" aria-hidden="true">
...
function PlFlag() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="16" viewBox="0 0 24 16" className="rounded-sm" aria-hidden="true">
