export function GitHubIcon({ className }: { className?: string }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" className={className ?? "fill-zinc-400 transition-colors hover:fill-zinc-100"} aria-hidden="true">
